...
def export_silver_company_to_seed():
    ...
    try:
        ...
        logger.info(f"Initiating data extraction for dbt seed. Source Table: '{table_path}'.")
        ...
        logger.error(f"Failed to export silver company data to dbt seed. Error: {e}", exc_info=True)