...
COMMON_META_FIELDS = [
    ...
    NestedField(
        field_id=101, name="data_type", field_type=StringType(), required=False
    ),
    ...
    NestedField(
        field_id=104, name="created_at_ts", field_type=TimestamptzType(), required=False
    ),
    NestedField(
        field_id=105,
...
ORIGINAL_TICKER_SCHEMA = Schema(
    ...
    NestedField(
        field_id=6, name="com_type_code", field_type=StringType(), required=False
    ),
...
FINANCIAL_REPORTS_SCHEMA = Schema(
    ...
    NestedField(
        field_id=4, name="indicator_id", field_type=IntegerType(), required=False
    ),
    NestedField(
        field_id=5, name="indicator_name", field_type=StringType(), required=False
    ),
...
PARTITION_BY_EVENT_YEAR = PartitionSpec(
    PartitionField(
        source_id=2, field_id=1000, transform=IdentityTransform(), name="event_year"
    )
)
PARTITION_BY_REPORT_YEAR = PartitionSpec(
    PartitionField(
        source_id=2, field_id=1000, transform=IdentityTransform(), name="report_year"
    )
)
FINANCIAL_REPORTS_PARTITION = PartitionSpec(
    PartitionField(
        source_id=2, field_id=1000, transform=IdentityTransform(), name="year"
    ),
    PartitionField(
        source_id=101, field_id=1001, transform=IdentityTransform(), name="data_type"
    ),
)
