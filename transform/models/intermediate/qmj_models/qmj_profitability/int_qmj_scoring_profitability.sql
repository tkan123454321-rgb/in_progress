...
z_profitability as(
    SELECT *,
        (
            ...
            STDDEV_SAMP(gpoa_rank) OVER (PARTITION BY absolute_quarter),
            0
        ) AS z_gpoa,
        -- Z-Score cho ROE
        (
            ...
            STDDEV_SAMP(roe_rank) OVER (PARTITION BY absolute_quarter),
            0
        ) AS z_roe,
        -- Z-Score cho ROA
        (
            ...
            STDDEV_SAMP(roa_rank) OVER (PARTITION BY absolute_quarter),
            0
        ) AS z_roa,
        -- Z-Score cho CFOA
        (
            ...
            STDDEV_SAMP(cfoa_rank) OVER (PARTITION BY absolute_quarter),
            0
        ) AS z_cfoa,
        -- Z-Score cho GMAR
        (
            ...
            STDDEV_SAMP(gmar_rank) OVER (PARTITION BY absolute_quarter),
            0
        ) AS z_gmar,
        -- Z-Score cho ACC
        (
            ...
            STDDEV_SAMP(acc_rank) OVER (PARTITION BY absolute_quarter),
            0
        ) AS z_acc
