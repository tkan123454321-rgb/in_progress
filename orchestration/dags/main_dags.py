...
from orchestration.dags.common.cosmos_config import (
    profile_config,
    project_config,
    execution_config,
)
...
from orchestration.dags.task_groups import (
    dividend_processing_group,
    historical_quotes_task_group,
    quarter_financial_reports_group,
)
...
def run_weekly():
    ...
    (
        dividend_group
        >> historical_quotes_group
        >> dbt_transform_qmj_model
        >> frontend_serving_task
    )  # type: ignore
